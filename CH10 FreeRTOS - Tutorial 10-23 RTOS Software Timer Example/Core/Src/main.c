...
/**
  ...
  */
	...
	/***************************** Tutorial Tags ******************************
		 FreeRTOS
		 Task management
		 Software Timer in RTOS
		 GPIO output
	 **************************************************************************/

	/* 10.7 Software timers in FreeRTOS: **************************************
	 * Tutorial -10-23: RTOS Software Timer Example

    In this tutorial, provide an example on the usage of the software timer in FreeRTOS
    Setup a software timer within a task to toggle the green led periodically at 1 second
    intervals
...
int main(void)
{
  ...
  Timer1Handle = osTimerNew(Timer_Callback1 , osTimerPeriodic , NULL, &Timer1_attributes);
