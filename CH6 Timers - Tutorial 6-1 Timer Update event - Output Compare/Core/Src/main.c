 ...
 */
	/***************************** Tutorial Tags ******************************
	 ...
	 Base Timer Output compare no output
	 Base timer interrupts
	 **************************************************************************/

	/* 6.4.1 Timer Usage C Language: ******************************************
	* Tutorial 6-1: Toggling the red and green LEDs using the TIM1 update and
	* compare interrupts, in     C language
...
int main(void)
{
  ...
  // Reset update flag for Timer 1 after being set in timer init function MX_TIM1_Init();"
...
/* USER CODE BEGIN 4 */
// Callback function to execute following the update event interrupt
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim){
	HAL_GPIO_TogglePin(GPIOG , GPIO_PIN_13);
}

// Callback function to execute following the capture/compare interrupt
