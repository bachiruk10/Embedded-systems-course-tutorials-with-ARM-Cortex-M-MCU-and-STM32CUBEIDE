...
/**
  ...
  */
	 ...
	 * Tutorial 8-10: Usage of the SPI module in blocking operation mode, the C code
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  // Transmit data between Master SPI4 to Slave SPI5 in duplex mode

	  HAL_SPI_TransmitReceive(&hspi4, &masterTxdata, &masterRxdata, 1, 1000);

	  HAL_SPI_TransmitReceive(&hspi5, &slaveTxdata, &slaveRxdata, 1, 1000);
