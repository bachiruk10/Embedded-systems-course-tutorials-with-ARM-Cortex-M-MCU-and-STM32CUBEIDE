...
/**
  ...
  */
	 ...
	 * Tutorial -10-4: The second task example in FreeRTOS

    In the second example, given in this tutorial, we modify the idle task of the
	...
	and enable the “USE_IDLE_HOOK” option under the “Hook function related definitions.”
	We should modify the function void vApplicationIdleHook(void)
	...
	In this tutorial, the defaultTask turns on the red LED on the STM32F4 board,
