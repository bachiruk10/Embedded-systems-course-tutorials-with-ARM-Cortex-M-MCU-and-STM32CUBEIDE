...
/**
  ...
  */
	...
	/* 10.3 Task in FreeRTOS: **************************************
	 * Tutorial -10-3: The first task example in FreeRTOS

    In this tutorial, we create a new task named myTask02 apart
	...
	The code in this tutorial is formed such that the green LED on the STM32F4
...
void StartTask02(void *argument)
{
  ...
  for(;;)
  {
	  ...
	  cn = 2;
	  printf("Task02: %u\n\r", cn);
	  osDelay(500);  // wait for 500 m seconds

	  /*Check difference between HAL_Delay and odDelay*/
	  /*
	   * HAL_Delay(2000);
	  ret = osThreadYield();
	  if (ret!=0)
