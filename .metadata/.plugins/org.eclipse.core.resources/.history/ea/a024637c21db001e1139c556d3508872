...
/**
  ...
  */
	 ...
	 * Tutorial -10-5: The third task example in FreeRTOS

    In this tutorial, we add Timer 2 to the code given in
	...
	modify ITM (Instrumentation Trace Marco Debug) properties as explained in Sect. 3.4.1.1
	of the book to observe printing results in this example.
