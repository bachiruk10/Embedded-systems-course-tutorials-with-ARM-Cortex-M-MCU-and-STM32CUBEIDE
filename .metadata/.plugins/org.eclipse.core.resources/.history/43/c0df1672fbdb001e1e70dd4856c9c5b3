...
/**
  ...
  */
	 ...
	 * Tutorial -10-19: The first queue example in FreeRTOS

    In this tutorial, we transfer a variable between two tasks using
	...
	queue. Then, the default task yields for 1 s. myTask02 is kept in the waiting state
...
int main(void)
{
  ...
  Queue1Handle =  osMessageQueueNew(1, sizeof(int), &Queue1_attributes);
